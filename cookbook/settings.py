...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # testing
    'cloudinary',
    'django_summernote',
    'crispy_forms',
    'recipe_site',
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # testing
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # might not use in project
